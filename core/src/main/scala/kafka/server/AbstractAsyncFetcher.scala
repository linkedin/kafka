...
case class AddPartitions(initialFetchStates: Map[TopicPartition, InitialFetchState], future: KafkaFutureImpl[Void]) extends FetcherEvent {
 ...
 */
abstract class AbstractAsyncFetcher(name: String,
                                     clientId: String,
