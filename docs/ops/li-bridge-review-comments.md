...
| F28: old producer times out obtaining recreated-topic metadata | Latest PR 594 CI failure is retained. Six diagnostic replays passed but exposed long bootstrap waits; the unchanged client jar confirms the initial-failure expiry branch. No client profile or deadline was relaxed. | Deterministic network reproduction and client-floor qualification remain open. |
